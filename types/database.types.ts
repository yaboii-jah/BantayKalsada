...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      report_activity_log: {
        Row: {
          action: Database["public"]["Enums"]["report_activity_action"]
        ...
        Relationships: [
          {
            foreignKeyName: "report_activity_log_report_id_fkey"
            columns: ["report_id"]
            isOneToOne: false
            referencedRelation: "reports"
            referencedColumns: ["id"]
      ...
      report_flags: {
        Row: {
          created_at: string
          flag_type: Database["public"]["Enums"]["report_flag_type"]
          id: string
          report_id: string
          user_id: string
        }
      ...
      reports: {
        Row: {
          ...
          resolved_image_urls: string[] | null
        ...
        Relationships: [
          {
            foreignKeyName: "reports_duplicate_of_id_fkey"
    ...
    Functions: {
      ...
      get_nearby_reports: {
        Args: { lat: number; lng: number; max_distance_m?: number }
        Returns: {
          category: Database["public"]["Enums"]["report_category"]
          distance_m: number
          id: string
      ...
      is_within_boundary: {
        Args: { lat: number; lng: number; municipality_name: string }
        Returns: boolean
      }
    ...
    Enums: {
      barangay: "DOLORES" | "SAN_ISIDRO" | "SAN_JUAN" | "SANTA_ANA" | "MUZON"
      ...
      report_category:
        ...
        | "BROKEN_TRAFFIC_SIGN"
        | "OTHER"
      report_flag_type: "ALREADY_FIXED" | "WRONG_LOCATION"
      report_severity: "MINOR" | "URGENT" | "EMERGENCY"
