...
12. **Email notifications** — Resend integrated. React Email templates created. Emails sent on: report approved, report rejected (with reason), report resolved. Delivery verified in staging.
